...
Route::post('code-verification', 'VerificationController@verify')->name('code-verification');
...
Route::middleware('auth')->group(function () {
    ...
    Route::resource('orders-apply-partner', 'OrderApplyPartnerController')->except([
        'create', 'store',
    ]);
