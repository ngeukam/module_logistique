...
abstract class ParentOrderController extends Controller
{
     ...
     */
    protected $orderLocationsStatusRepository;
    /**
     ...
     */
    public function __construct(OrderRepository $orderRepo, ProductOrderRepository $productOrderRepository, CartRepository $cartRepo, PaymentRepository $paymentRepo, NotificationRepository $notificationRepo, UserRepository $userRepository, OrderStatusRepository $orderStatusRepository, OrderLocationsStatusRepository $orderLocationsStatusRepository ,CouponRepository $couponRepository)
    {
        parent::__construct();
        ...
        $this->orderLocationsStatusRepository = $orderLocationsStatusRepository;
