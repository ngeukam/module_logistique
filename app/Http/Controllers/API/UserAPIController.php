...
class UserAPIController extends Controller
{
    ...
    function register(Request $request)
    {
        try {
            ...
            Session::put('phonenumberSession',$request->input('phone'));
            Session::put('verificationcodeSession',$request->input('verification_code'));
    ...
    function verification(VerificationRequest $request)
    {
        try {
            $input = $request->all();
            if ($input['check_code']==$input['verification_code']) {
                ...
                return response()->json([
                    "successcodeverif" =>  __('lang.success_code_verification')
                ], 201);
            }
        }
        catch(\Exception $e){
