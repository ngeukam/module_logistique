...
/**
 * generate orderlocationsstatus column for datatable
 * @param $column
 * @return string
 */
function getOrderLocations($column, $attributeName)
{
    if (isset($column) && $column[$attributeName]) {
        return "<span class='badge badge-danger'>" . trans('lang.order_waiting_to_load') . "</span>";
    }
}
