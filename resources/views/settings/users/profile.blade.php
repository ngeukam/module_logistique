...
@section('content')
    ...
    <div class="content-header">
        @if (session('successcodeverif'))
            <div class="alert alert-success" role="alert">
                {{session('successcodeverif')}}
            </div>
        @endif
                ...
                <div class="col-md-3">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body box-profile">
                            ...
                            @if(auth()->user()->isVerified==0 and !empty(Session::get('phonenumberSession')))
                                <a class="btn btn-outline-danger btn-block" href="{{url('/verify')}}"><i class="fa fa-unlock mr-2"></i>{{trans('lang.user_activated_account')}}
                                </a>
                            @endif
                        </div>
                        <!-- /.card-body -->
